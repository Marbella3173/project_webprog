...
<div style="margin-left: 100px">
    ...
    <form style="margin-bottom: 30px" action="/manage" method="get">
        ...
        <div class="mb-3 radio-inline text-light">
            ...
            <input type="checkbox" id="main-course" class = "form-check-input" style="margin-left: 10px" name="main" @if ($category['Main Course'])
                checked
            @endif>
            <label for="main-course" class="form-check-label" >Main Course</label>

            <input type="checkbox" id="beverages" class = "form-check-input" style="margin-left: 10px" name="beverage" @if ($category['Beverages'])
                checked
            @endif>
            <label for="beverages">Beverages</label>

            <input type="checkbox" id="dessert" class = "form-check-input" style="margin-left: 10px" name="dessert" @if ($category['Dessert'])
            checked
            @endif>
    ...
    <div class = "container" style = "margin-left: 0px">
        ...
        @foreach ($product as $product)
                <div class = "col">
                    ...
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="/assets/Food/{{ $product->image }}" class="img-fluid rounded-start" alt="No Picture Found" style="object-fit: cover; height: 100%">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title text-warning" style="font-weight: bold">{{ $product->name }}</h5>
                                <p class="card-text">
