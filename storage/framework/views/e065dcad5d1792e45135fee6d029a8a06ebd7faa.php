    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(($title === "Add") ? 'active' : ''); ?>" href="/add">Add New Food</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(($title === "Manage") ? 'active' : ''); ?>" href="/manage">Manage Food</a>
                </li>
                <!-- <li class="nav-item">
...
</nav><?php /**PATH C:\xampp\htdocs\PROJECT WEBPROG\project\resources\views/partials/navbar3.blade.php ENDPATH**/ ?>