        ...
        <table class="table table-bordered" style="border-color:black; ">
            ...
            <tbody>
                ...
                <tr class="align-middle text-light" style="background-color: dimgrey; text-align: center; font-weight: bold">
                    <td>TR<?php echo e(str_pad($transaction->transactionHeader->id, 3, "0", STR_PAD_LEFT)); ?></td>
                    <td><?php echo e(date_format($transaction->created_at, "Y-m-d")); ?></td>
                    <td><?php echo e($transaction->food_name); ?> [x<?php echo e($transaction->quantity); ?>]</td>
                    <td>Rp <?php echo e($transaction->food_price * $transaction->quantity); ?></td>
                </tr>
...
<?php echo $__env->make('partials.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PROJECT WEBPROG\project\resources\views/transaction.blade.php ENDPATH**/ ?>